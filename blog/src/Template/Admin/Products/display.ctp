...
<div id="contents">
  <div id="product">
    ...
    <div class="section">
      ...
      <p>Giá           : <span><?=$product->products_price?> VNĐ</span></p>
      <p>Model         : <?=$product->products_model?></p>      
      <p>Loại sản phẩm : <?php echo $this->Html->link( h($product->product_category->categories_name),['controller' => 'Products', 'action' => 'categories',$product->product_category->categories_id]);?></p>
      <p>Nhà sản xuất  : <?=$product->manufacturer->manufacturers_name?></p>
      <p>Số lượng      : <?=$product->products_quantity?> </p>
