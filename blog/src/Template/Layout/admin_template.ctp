  ...
  <aside class="left-side sidebar-offcanvas"> 
    ...
    <section class="sidebar"> 
      ...
      <ul class="sidebar-menu">
        ...
        <li> <a href="/"> <i class="fa fa-th"></i> <span>Articles</span> <small class="badge pull-right bg-green">s</small> </a> </li>
        ...
        <li class="treeview"> <a href="/Categories"> <i class="fa fa-folder"></i> <span>Categories</span> <i class="fa fa-angle-left pull-right"></i> </a>
          <ul class="treeview-menu">
