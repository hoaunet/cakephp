...
class ProvincesController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['ParentProvinces', 'Countries']
        ];
    ...
    public function view($id = null)
    {
        $province = $this->Provinces->get($id, [
            'contain' => ['ParentProvinces', 'Countries', 'ChildProvinces', 'Schools', 'Users']
        ]);
    ...
    public function add()
    {
        ...
        $parentProvinces = $this->Provinces->ParentProvinces->find('list', ['limit' => 200]);
        $countries = $this->Provinces->Countries->find('list', ['limit' => 200]);
        $this->set(compact('province', 'parentProvinces', 'countries'));
        $this->set('_serialize', ['province']);
    }
