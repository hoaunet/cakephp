  ...
  <aside class="left-side sidebar-offcanvas"> 
    ...
    <section class="sidebar"> 
      ...
      <ul class="sidebar-menu">
        ...
        <li><?php echo $this->Html->link('Tin tức',
    							['controller' => 'Articles', 'action' => 'index', '_full' => true]);?> </li>
        <li><?php echo $this->Html->link('Thể loại',
    							['controller' => 'Categories', 'action' => 'index', '_full' => true]);?> </li>
        <li><?php echo $this->Html->link('Nghề nghiệp',['controller' => 'Careers', 'action' => 'index', '_full' => true]);?></li>                        
        <li><?php echo $this->Html->link('Công ty',['controller' => 'Companies', 'action' => 'index','_full' => true, 'prefix' => 'admin']);?></li>
        <li><?php echo $this->Html->link('Ứng viên',['controller' => 'Resumes', 'action' => 'index', '_full' => true]);?></li>
        <li><?php echo $this->Html->link('Tỉnh thành',['controller' => 'Provinces', 'action' => 'index', '_full' => true]);?></li>
        <li><?php echo $this->Html->link('Quốc gia',['controller' => 'Countries', 'action' => 'index', '_full' => true]);?></li>
        <li><?php echo $this->Html->link('Ngôn ngữ',['controller' => 'Languages', 'action' => 'index', '_full' => true]);?></li>
        <li><?php echo $this->Html->link('Bằng cấp',['controller' => 'Degrees', 'action' => 'index', '_full' => true]);?>
