...
<div class="ctl">
  ...
  <div class="rgr"><?php echo $this->Form->control('user.password',['label'=>'','type'=>'password']);?></div>
  <div class="cl"></div>
  ...
  <div class="rgr"><?php echo $this->Form->control('company.name',['label'=>'']);?>   
  </div>
  <div class="cl"></div>
  ...
  <div class="rgr"><?php echo $this->Form->control('company.website',['label'=>'']);?> 
  ...
  <div class="rgr"><?php echo $this->Form->control('user.name',['label'=>'']);?>
  ...
  <div class="rgr"><?php echo $this->Form->control('company.contact_phone',['label'=>'']);?>    
  </div>
  <div class="cl"></div>
  ...
  <div class="bt">
    ...
    <?= $this->Form->Button('Làm lại', ['type' => 'reset']) ?>
  </div>
</div>
<?= $this->Form->end() ?>
<div class="ctr">
  ...
  <ul class="vipr">
    <li class="sr">
      ...
      <div class="r"><?php echo $this->Form->control('careers', ['label'=>'','options' => $careers,'empty' => 'Chọn ngành nghề']);?>     
      </div>
      <div class="cl"></div>
      ...
      <div class="r"><?php echo $this->Form->control('provinces', ['label'=>'','options' => $provinces,'empty' => 'Chọn địa điểm']);?>        
      </div>
      <div class="cl"></div>
      <div class="l">Mức lương</div>
      <div class="r"><?php echo $this->Form->control('salaries', ['label'=>'','options' => $salaries,'empty' => 'Chọn mức lương']);?>        
      </div>
      <div class="cl"></div>
      ...
      <div class="r"><?php echo $this->Form->control('languages', ['label'=>'','options' => $languages,'empty' => 'Chọn ngoại ngữ']);?>        
        
      </div>
      <div class="cl"></div>
      <div class="l" style="text-align:right; ">
        <?php echo $this->Form->submit('btnTimkiem.gif');?>        
      </div>
      <div class="r">
        <?php echo $this->Form->control('',['type'=>'reset','style'=>"background:'btnHuyTimkiem.gif'"]);?>
  ...
  <ul class="vipr">
    <li class="search"><a href="#">Việc làm lương từ 30 triệu trở lên</a> <a href="#">Việc làm lương từ 20 - 30 triệu</a> <a href="/nguoi-tim-viec/tim-kiem-viec-lam-nhanh-c0.html?key=&n=Tất cả&d=0&l=7">Việc làm lương từ 15 -20 triệu</a> <a href="/nguoi-tim-viec/tim-kiem-viec-lam-nhanh-c0.html?key=&n=Tất cả&d=0&l=6">Việc làm lương từ 10 - 15 triệu</a> <a href="/nguoi-tim-viec/tim-kiem-viec-lam-nhanh-c0.html?key=quan ly&n=Tất cả&d=0&l=0">Việc làm cấp quản lý</a> <a href="/nguoi-tim-viec/lam-ban-thoi-gian-c103.html">Việc làm bán thời gian</a> <a href="/nguoi-tim-viec/thuc-tap-c107.html">Việc làm cho sinh viên thực tập, mới tốt nghiệp</a> </li>
  </ul>
