    ...
    <div class="col-xs-12">
      <table width="100%" cellpadding="2" border="0" cellspacing="2">
        ...
        ?></td>
          ...
          <td><?=$this->Html->link(__('Danh sách thể loại cha'), ['controller' => 'Categories', 'action' => 'index',$category->parent_id]) ?></td>
  ...
  <div class="row"> 
    ...
    <div class="col-md-12"> 
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          <div class="form-group"><?php echo $this->Form->control('parent_id', ['label'=>'Thể loại  : ','options' => $parentCategories]);?></div>
