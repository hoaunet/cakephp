...
class CompanyusersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'FK_CompanyCompanyuser' => ['type' => 'index', 'columns' => ['company_id'], 'length' => []],
            'FK_UserCompanyuser' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'is_active' => 1,
            'est_billing_amt' => 1,
            'act_date' => '2017-06-15 13:19:04',
            'billing_start_date' => '2017-06-15 13:19:04',
            'billing_end_date' => '2017-06-15 13:19:04',
            'created' => '2017-06-15 13:19:04',
            'modified' => '2017-06-15 13:19:04'
        ],
    ];
}
