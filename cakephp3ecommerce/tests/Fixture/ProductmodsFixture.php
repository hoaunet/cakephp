 ...
 *
 */
class ProductmodsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'sku' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'value' => '10702f69-8ad6-4ccb-954c-b08e7620b077',
            'price' => 1.5,
            'weight' => 1.5,
            'active' => 1,
            'views' => 1,
            'created' => '2017-06-05 07:46:58',
            'modified' => '2017-06-05 07:46:58'
        ],
    ];
}
