...
/**
 * CaseFileDrivesFixture
 *
 */
class CaseFileDrivesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'file_info' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        '_constraints' => [
