...
use App\Model\Table\ProjectTemplatesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ProjectTemplatesTable Test Case
 */
class ProjectTemplatesTableTest extends TestCase
{
     ...
     * Test subject
     *
     * @var \App\Model\Table\ProjectTemplatesTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ProjectTemplates') ? [] : ['className' => 'App\Model\Table\ProjectTemplatesTable'];
