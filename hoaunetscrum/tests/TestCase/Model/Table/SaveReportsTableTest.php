...
use App\Model\Table\SaveReportsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\SaveReportsTable Test Case
 */
class SaveReportsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\SaveReportsTable
     */
    public $SaveReports;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('SaveReports') ? [] : ['className' => 'App\Model\Table\SaveReportsTable'];
        $this->SaveReports = TableRegistry::get('SaveReports', $config);
    }
