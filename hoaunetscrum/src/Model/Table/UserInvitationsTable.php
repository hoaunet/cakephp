 ...
 *
 * @property \Cake\ORM\Association\BelongsTo $Invitors
 * @property \Cake\ORM\Association\BelongsTo $Companies
 * @property \Cake\ORM\Association\BelongsTo $Projects
 * @property \Cake\ORM\Association\BelongsTo $Users
 *
 * @method \App\Model\Entity\UserInvitation get($primaryKey, $options = [])
 * @method \App\Model\Entity\UserInvitation newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\UserInvitation[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\UserInvitation|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\UserInvitation patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\UserInvitation[] patchEntities($entities, array $data, array $options = [])
...
class UserInvitationsTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsTo('Invitors', [
            'foreignKey' => 'invitor_id',
            'joinType' => 'INNER'
        ]);
    ...
    {
        $rules->add($rules->existsIn(['invitor_id'], 'Invitors'));
