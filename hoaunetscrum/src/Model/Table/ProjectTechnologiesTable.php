 ...
 * @property \Cake\ORM\Association\BelongsTo $Technologies
 *
 * @method \App\Model\Entity\ProjectTechnology get($primaryKey, $options = [])
 * @method \App\Model\Entity\ProjectTechnology newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ProjectTechnology[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ProjectTechnology|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ProjectTechnology patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ProjectTechnology[] patchEntities($entities, array $data, array $options = [])
