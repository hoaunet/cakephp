 ...
 * @method \App\Model\Entity\TimezoneName newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\TimezoneName[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\TimezoneName|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\TimezoneName patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\TimezoneName[] patchEntities($entities, array $data, array $options = [])
