 ...
 * @method \App\Model\Entity\EasycaseMilestone newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\EasycaseMilestone[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\EasycaseMilestone|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\EasycaseMilestone patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\EasycaseMilestone[] patchEntities($entities, array $data, array $options = [])
