 ...
 * @method \App\Model\Entity\LogActivity newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\LogActivity[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\LogActivity|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\LogActivity patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\LogActivity[] patchEntities($entities, array $data, array $options = [])
...
class LogActivitiesTable extends Table
{
    ...
    public function buildRules(RulesChecker $rules)
    {
        ...
        $rules->add($rules->existsIn(['log_type_id'], 'LogTypes'));
