...
class EasycasesController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['Uniqs', 'Projects', 'Users', 'Types']
        ];
    ...
    public function view($id = null)
    {
        $easycase = $this->Easycases->get($id, [
            'contain' => ['Uniqs', 'Projects', 'Users', 'Types', 'Archives', 'CaseActions', 'CaseActivities', 'CaseFileDrives', 'CaseFiles', 'CaseRecents', 'CaseUserEmails', 'CaseUserViews', 'EasycaseMilestones']
        ]);
    ...
    public function add()
    {
        ...
        $uniqs = $this->Easycases->Uniqs->find('list', ['limit' => 200]);
        $projects = $this->Easycases->Projects->find('list', ['limit' => 200]);
        $users = $this->Easycases->Users->find('list', ['limit' => 200]);
        $types = $this->Easycases->Types->find('list', ['limit' => 200]);
        $this->set(compact('easycase', 'uniqs', 'projects', 'users', 'types'));
        $this->set('_serialize', ['easycase']);
    }
