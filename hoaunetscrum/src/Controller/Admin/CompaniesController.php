...
class CompaniesController extends AppController
{
    ...
    public function view($id = null)
    {
        $company = $this->Companies->get($id, [
            'contain' => ['Uniqs', 'Subscriptions', 'Archives', 'CaseFiles', 'CaseRecents', 'CaseTemplates', 'CompanyUsers', 'CustomFilters', 'DailyUpdates', 'DailyupdateNotifications', 'DefaultProjectTemplateCases', 'DefaultProjectTemplates', 'LogActivities', 'Milestones', 'ProjectTemplateCases', 'ProjectTemplates', 'ProjectUsers', 'Projects', 'TemplateModuleCases', 'Transactions', 'TypeCompanies', 'Types', 'UserInvitations', 'UserSubscriptions']
        ]);
